...
################################################################
# This is a generated script based on design: mux2x1_BD
#
...
proc create_root_design { parentCell } {
  ...
  set c [ create_bd_port -dir O -from 7 -to 0 c ]
  ...
  connect_bd_net -net b_1 [get_bd_ports b] [get_bd_pins andgate_1/b]
  connect_bd_net -net notgate_0_c [get_bd_pins andgate_1/a] [get_bd_pins notgate_0/c]
  connect_bd_net -net orgate_0_c [get_bd_ports c] [get_bd_pins orgate_0/c]
  connect_bd_net -net sel_1 [get_bd_ports sel] [get_bd_pins andgate_0/b] [get_bd_pins notgate_0/a]
